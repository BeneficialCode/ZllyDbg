...
class CThreadFrame : public CMDIChildWindowImpl<CThreadFrame> {
public:
	DECLARE_FRAME_WND_CLASS(NULL, IDR_MDICHILD_THREAD)
	...
	BEGIN_MSG_MAP(CThreadFrame)
		...
		CHAIN_MSG_MAP(CMDIChildWindowImpl<CThreadFrame>)
	END_MSG_MAP()
...
public:
	static CThreadTable* m_ThreadTable;
};